...
# ============================================================================
gnuplot << EOF
set output './output/img/dao_avgTrend_comparison_Users_trend.png'
...
# ============================================================================
gnuplot << EOF
set output './output/img/dao_avgTrend_comparison_Proposals_trend.png'
...
# ============================================================================
gnuplot << EOF
set output './output/img/dao_avgTrend_comparison_Votes_trend.png'
